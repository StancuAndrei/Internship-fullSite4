        ...
        return (
            ...
            <div class="flex flex-wrap">
              ...
              <div class="w-full md:w-1/2 userDetails">
                <img src="${curentValue.avatar}" alt="user picture" class="w-full profileImg md:w-1/3"/>
                ...
                <div class="w-full md:w-1/2">
                  ...
                  <div class="flex justify-evenly w-full m-1">
                    <button class="btn-modal btn-blue m-1" id="hardSkilsBtn">
                      Hard Skils
                    </button>
                    <button class="btn-modal btn-blue m-1" id="softSkilsBtn">
                      Soft Skils
                    </button>
                  </div>
          ...
          >
            ...
            <div class="flex justify-evenly">
              <a href="${curentValue.links.git}" class="hover:text-red-800"><i class="fab fa-github"></i></a>
              <a href="${curentValue.links.linkedin}" class="hover:text-red-800"><i class="fab fa-linkedin"></i></a>
              <a href="${curentValue.links.facebook}" class="hover:text-red-800"><i class="fab fa-facebook"></i></a>
            </div>
            `
        );
    }, " ");
